                        ...
                        <div class="blog-posts-area">
                            ...
                            <div class="single-blog-post featured-post single-post">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{ Voyager::image( $post->image ) }}" alt=""></a>
                                </div>
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        <div class="entry-meta">
                                            <ul>
                                                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">{{ $post->authorId->name }}</a></li>
